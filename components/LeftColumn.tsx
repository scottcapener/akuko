  ...
  return (
    <div className="flex flex-col h-full bg-[#18181a] border-r border-[#2a2a2c] w-full">
      ...
      <div className="px-5 pt-6 pb-2 flex-shrink-0">
        <span
          className="font-mono text-lg tracking-tight text-[#c4a882] select-none"
      ...
      <div className="px-4 pb-4 flex-shrink-0">
        {/* Cover placeholder */}
        <div
          className="w-full aspect-[2/3] rounded-md mb-3 flex items-center justify-center"
          style={{ backgroundColor: book.coverColor }}
        >
          <span className="text-[#9b9890] text-xs uppercase tracking-widest opacity-40 select-none">
            Cover
          </span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4">
        ...
        <div className="grid grid-cols-3 gap-1.5">
          ...
          <button
            ...
            className="aspect-[3/4] rounded bg-[#222224] text-[#9b9890] hover:bg-[#2a2a2c] hover:text-[#c4a882] transition-colors flex items-center justify-center group"
            title="Add chapter"
          >
            <svg
